...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Timesheet.signed_on'
        db.add_column(u'clocker_timesheet', 'signed_on',
                      self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Timesheet.timesheet_hash'
        db.add_column(u'clocker_timesheet', 'timesheet_hash',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Timesheet.signed_on'
        db.delete_column(u'clocker_timesheet', 'signed_on')

        # Deleting field 'Timesheet.timesheet_hash'
        db.delete_column(u'clocker_timesheet', 'timesheet_hash')
    ...
    models = {
        u'clocker.employee': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 19, 0, 0)'}),
        ...
        u'clocker.timesheet': {
            ...
            'signed_on': ('django.db.models.fields.BigIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'start': ('django.db.models.fields.BigIntegerField', [], {}),
            'timesheet_hash': ('django.db.models.fields.TextField', [], {})
        }
    }
